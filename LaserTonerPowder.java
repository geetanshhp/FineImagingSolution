...
public class LaserTonerPowder extends AppCompatActivity
{
    ImageView imageView;
    TextView textView;
    ...
    DatabaseReference point=database.getReference("LaserTonerPowder/P1");

    @Override
    protected void onCreate(Bundle savedInstanceState)
    {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_laser_toner_powder);
        progressDialog=new ProgressDialog(this);
        progressDialog.setTitle("Please Wait");
        progressDialog.setMessage("Data is being Loading");
        progressDialog.show();
        textView=findViewById(R.id.textlasertonerpowder);
        imageView=findViewById(R.id.imagelaserpower);
    ...
    private void GetText()
    {
        point.addValueEventListener(new ValueEventListener() {
            ...
            public void onCancelled(@NonNull DatabaseError databaseError)
            {
                ...
                Toast.makeText(LaserTonerPowder.this, "No internet", Toast.LENGTH_SHORT).show();
                progressDialog.dismiss();
            }
        });
    ...
    private void GetImage()
    {
        ...
        StorageReference fisrt=reference.child("lasertonerpowder.jpg");
        File myfile=null;
        try
        {
